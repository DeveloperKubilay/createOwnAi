...
max_retries = 5
batch_size = 1000  # her kaç dosyada bir flush
        ...
        try:
            ...
            if resp.ok:
                with gzip.GzipFile(fileobj=io.BytesIO(resp.content)) as f:
                    ...
                    # Tüm satır sonlarını boşlukla birleştir, tek satır yap
                    single_line = " ".join(raw.splitlines())
                    return blob_id, single_line
            else:
                    ...
                    for blob_id in tqdm(blob_ids, desc="S3'ten paralel çekiliyor", leave=False):
                        ...
                        if len(pending) >= max_inflight:
                            ...
                            for d in done:
                                ...
                                if total_blobs_processed % batch_size == 0:
                                    out_file.flush()
